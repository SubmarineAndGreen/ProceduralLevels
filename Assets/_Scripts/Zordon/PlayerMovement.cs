...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        //resetuj jetpack, je�li na ziemi
        if (isGrounded && jetpackUsedTime != 0)
        {
            if (jetpackUsedTime < 2) jetpackUsedTime = 0;
            jetpackUsedTime -= 2;
        }
        //je�li w powietrzu, zamiast skoku u�yj jetpacka i zwi�ksz zu�ycie si� jetpacka
    ...
    //zmie� opory je�li na ziemi lub powietrzu
    ...
    {
        MovePlayer();
        //grawitacja zale�na od masy, niezale�na od opor�w powietrza
